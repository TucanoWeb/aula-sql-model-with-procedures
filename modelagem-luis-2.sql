...
DELIMITER $$
USE `mydb`$$
CREATE PROCEDURE deleteProduct(IN id_product INT, IN user_id_value INT)
BEGIN 
	DELETE from produtos WHERE id=id_product;
    INSERT INTO logs (command, produto_id, users_id) VALUES ("Delete Product", id_product, user_id_value);
END$$
...
CALL createUser ("Usuário Teste");

-- -----------------------------------------------------
-- 2 - EDIT PRODUCTS (with trigger - see createProduct Procedure above)
-- -----------------------------------------------------

CALL createProduct ("Branco", "R$ 10", "10x10", "10kg", 1);
CALL createProduct ("Azul", "R$ 15", "10x101", "12kg", 1);
CALL createProduct ("Branco", "R$ 30", "110x10", "13kg", 1);
CALL createProduct ("Amarelo", "R$ 12", "102x10", "14kg", 1);
CALL createProduct ("Branco", "R$ 14", "10x130", "15kg", 1);
CALL createProduct ("Branco", "R$ 16", "10x106", "16kg", 1);
CALL createProduct ("Amarelo", "R$ 10", "10x103", "17kg", 1);
CALL createProduct ("Branco", "R$ 15", "10x102", "18kg", 1);
CALL createProduct ("Branco", "R$ 11", "10x107", "19kg", 1);
CALL createProduct ("Amarelo", "R$ 19", "10x102", "14kg", 1);
CALL createProduct ("Branco", "R$ 12", "10x10", "11kg", 1);
CALL createProduct ("Verde", "R$ 21", "10x10", "12kg", 1);
CALL createProduct ("Branco", "R$ 43", "10x10", "13kg", 1);
CALL createProduct ("Azul", "R$ 56", "10x10", "14kg", 1);
CALL createProduct ("Branco", "R$ 90", "10x10", "15kg", 1);


-- -----------------------------------------------------
-- 3 - CALL UPDATE PRODUCT COLOR (with trigger - see createProduct Procedure above)
-- -----------------------------------------------------

CALL updateCorProduct (1, "Vermelho", 1);
CALL updateCorProduct (2, "Azul", 1);


-- -----------------------------------------------------
-- 4 - CALL DELETE PRODUCT (with trigger - see createProduct Procedure above)
-- -----------------------------------------------------

CALL deleteProduct (5, 1);
CALL deleteProduct (6, 1);
